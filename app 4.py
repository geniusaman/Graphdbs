...
from langchain_customllm.azure import AzureCohereLanguageModel
...
COHERE_API_ENDPOINT = os.environ["COHERE_API_ENDPOINT"]
...
#     """
#     Create an Azure OpenAI ChatCompletions client
#     """
...
# # Modify your LLM initialization in app.py
# llm_azure_openai = create_azure_openai_client()
 
llm_cohere = AzureCohereLanguageModel(endpoint=COHERE_API_ENDPOINT,
